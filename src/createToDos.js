...
const toDo1 = createToDoObject("Fart", "A compression of air exiting the after thereby making a noticeable sound", "01.01.0101", "AAA", "Only do the fart if the risk of a wet fart does not exceed 50%", "false");
